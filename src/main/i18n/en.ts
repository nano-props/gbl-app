...
export const en = {
  ...
  'menu.file.noRecent': 'No Recent Repositories',
  'menu.file.clearRecent': 'Clear Menu',
  'menu.file.openDataFolder': 'Open Data Folder in Finder',
  ...
  'action.fetchTitle': 'Sync remote and refresh status',
  ...
  'action.confirmForceDeleteBranchTitle': 'Delete local branch {branch}?',
  ...
  'action.confirmForceDeleteBranchConfirm': 'Remove worktree and force-delete branch',
  ...
  'help.section.branchActions': 'Branch actions',
