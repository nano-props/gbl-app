...
export const zh: Record<DictKey, string> = {
  ...
  'action.fetch-local-title': '刷新本地分支和状态',
  ...
  'action.confirm-force-delete-standalone-title': '强制删除分支？',
  'action.confirm-force-delete-standalone-body': '将会强制删除本地分支：',
  'action.confirm-force-delete-standalone-note': '这个本地分支有未合并的独有提交；确认不再需要后再继续。',
  ...
  'settings.terminal-notifications-test-failed-hint': '请前往系统设置 → 通知 → Goblin，确认已允许通知。',
  'settings.group.general': '通用',
  'settings.github.title': 'GitHub',
  'settings.github.body': '配置 GitHub.com 认证以使用 pull request 和其他 GitHub 功能。',
  'settings.github.token-label': '个人访问令牌',
  'settings.github.token-placeholder': 'ghp_...',
  'settings.github.token-hint': '使用 Classic PAT，并授予 repo 权限。已保存的 token 仅用于 GitHub.com。',
  'settings.github.configured-hidden': '已配置的 token 不会显示。',
  'settings.github.status-configured': '已配置',
  'settings.github.status-not-configured': '未配置',
  'settings.github.show-token': '显示令牌',
  'settings.github.hide-token': '隐藏令牌',
  'settings.github.clear': '清除',
  'settings.github.unavailable': '当前系统不可用安全存储，因此已禁用 GitHub token 存储。',
  ...
  'settings.proxy.http-title': 'HTTP(S) 远端',
  'settings.proxy.http-body':
    '如果你使用 HTTPS remote，请在 Goblin 外部配置 Git。这只影响 git 网络流量。',
  'settings.proxy.http-example':
    'git config --global http.proxy http://127.0.0.1:7890\n' +
    'git config --global https.proxy http://127.0.0.1:7890',
  'settings.proxy.ssh-title': 'SSH 远端',
  'settings.proxy.ssh-body':
    '如果你使用 SSH remote，请配置 ~/.ssh/config。Goblin 会沿用系统 git/ssh。',
