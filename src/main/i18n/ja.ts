...
export const ja: Record<DictKey, string> = {
  ...
  'menu.file.openRecent': '最近使った項目を開く',
  'menu.file.noRecent': '最近使ったリポジトリはありません',
  'menu.file.clearRecent': 'メニューを消去',
  'menu.file.openDataFolder': 'Finderでデータフォルダを開く',
  ...
  'action.fetchTitle': 'リモートを同期してステータスを更新',
  ...
  'action.confirmForceDeleteBranchTitle': 'ローカルブランチ {branch} を削除しますか？',
  'action.confirmForceDeleteBranchBody':
    'このブランチが安全にマージ済みか確認できず、上流が消失している可能性があります。ワークツリーを削除し、ローカルブランチを強制削除しますか？',
  'action.confirmForceDeleteBranchConfirm': 'ワークツリーを削除してブランチを強制削除',
  ...
  'help.section.branchActions': 'ブランチ操作',
