...
export const en = {
  ...
  'settings.proxy.external-badge': 'external',
  'settings.proxy.http-title': 'HTTP(S) remotes',
  'settings.proxy.http-body':
    'If you use HTTPS remotes, configure Git outside Goblin. This only affects git network traffic.',
