...
export const ko: Record<DictKey, string> = {
  ...
  'menu.file.openRecent': '최근 항목 열기',
  'menu.file.noRecent': '최근 리포지토리 없음',
  'menu.file.clearRecent': '메뉴 지우기',
  'menu.file.openDataFolder': 'Finder에서 데이터 폴더 열기',
  ...
  'menu.view.log': '커밋 로그',
  'menu.view.toggleDetail': '세부 패널 접기/펼치기',
  ...
  'branchDetail.collapse': '세부 패널 접기',
  'branchDetail.collapseTitle': '세부 패널 접기 (⌘J)',
  'branchDetail.expand': '세부 패널 펼치기',
  'branchDetail.expandTitle': '세부 패널 펼치기 (⌘J)',
  ...
  // ---- Branch status -----------------------------------------------------
  'branchStatus.worktreeDirty': '{n} 개 변경',
  'branchStatus.merged': '포함됨',
  'branchStatus.notMerged': '고유 커밋 있음',
  'branchStatus.mergeUnknown': '알 수 없음',
  'branchStatus.copyBranchName': '브랜치 이름 복사',
  'branchStatus.current': '현재',
  'branchStatus.protected': '보호됨',
  'branchStatus.copyWorktreePath': '워크트리 경로 복사',
  'branchStatus.copied': '복사됨',
  'branchStatus.signal.branch': '브랜치',
  'branchStatus.signal.remote': '원격',
  'branchStatus.signal.sync': '동기화',
  'branchStatus.signal.merge': '기준선',
  'branchStatus.signal.worktree': '워크트리',
  'branchStatus.signal.commit': '최근 커밋',
  'branchStatus.sync.upToDate': '최신',
  'branchStatus.worktree.none': '워크트리 없음',
  'branchStatus.worktree.locked': '잠김',
  'branchStatus.sync.ahead': '{n} 앞섬',
  'branchStatus.sync.behind': '{n} 뒤처짐',
  'branchStatus.pr.number': '#{n}',
  'branchStatus.pr.open': '열림',
  'branchStatus.pr.draft': '초안',
  'branchStatus.pr.merged': '병합됨',
  'branchStatus.pr.closed': '닫힘',
  ...
  'action.fetchTitle': '원격을 동기화하고 상태 새로 고침',
  ...
  'action.confirmForceDeleteStandaloneTitle': '{branch} 을(를) 강제 삭제할까요?',
  'action.confirmForceDeleteStandaloneBody.before': '로컬 브랜치 ',
  'action.confirmForceDeleteStandaloneBody.after':
    ' 에는 완전히 병합되지 않은 고유 커밋이 있습니다. 해당 커밋이 더 이상 필요 없을 때만 강제 삭제하세요.',
  'action.confirmForceDeleteStandaloneConfirm': '브랜치 강제 삭제',
  ...
  'action.confirmForceDeleteBranchTitle': '로컬 브랜치 {branch} 을(를) 삭제할까요?',
  'action.confirmForceDeleteBranchBody':
    '이 브랜치가 안전하게 병합되었는지 확인할 수 없고 업스트림이 사라졌을 수 있습니다. 워크트리를 제거하고 로컬 브랜치를 강제로 삭제할까요?',
  'action.confirmForceDeleteBranchConfirm': '워크트리 제거 및 브랜치 강제 삭제',
  ...
  'action.createWorktreeBranchInvalid': '올바른 Git 브랜치 이름을 입력하세요.',
  'action.createWorktreeBranchExists': '같은 이름의 브랜치가 이미 있습니다.',
  ...
  'error.branchNotFullyMerged': '브랜치에 고유 커밋이 있어 Git 이 안전 삭제를 거부했습니다',
  ...
  'help.section.branchActions': '브랜치 동작',
  ...
  'help.row.viewStatus': '브랜치 상태',
  'help.row.viewChanges': '변경 사항',
  'help.row.viewLog': '커밋 로그',
  'help.row.toggleDetail': '세부 패널 접기/펼치기',
