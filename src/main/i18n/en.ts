...
export const en = {
  ...
  'menu.view.log': 'Log',
  'menu.view.toggleDetail': 'Toggle Detail Panel',
  ...
  'branchDetail.collapse': 'Collapse detail panel',
  'branchDetail.collapseTitle': 'Collapse detail panel (⌘J)',
  'branchDetail.expand': 'Expand detail panel',
  'branchDetail.expandTitle': 'Expand detail panel (⌘J)',
  ...
  // ---- Branch status ------------------------------------------------------
  'branchStatus.worktreeDirty': '{n} change(s)',
  'branchStatus.merged': 'included',
  'branchStatus.notMerged': 'unique commits',
  'branchStatus.mergeUnknown': 'unknown',
  'branchStatus.copyBranchName': 'Copy branch name',
  'branchStatus.current': 'current',
  'branchStatus.protected': 'protected',
  'branchStatus.copyWorktreePath': 'Copy worktree path',
  'branchStatus.copied': 'Copied',
  'branchStatus.signal.branch': 'Branch',
  'branchStatus.signal.remote': 'Remote',
  'branchStatus.signal.sync': 'Sync',
  'branchStatus.signal.merge': 'Baseline',
  'branchStatus.signal.worktree': 'Worktree',
  'branchStatus.signal.commit': 'Last commit',
  'branchStatus.sync.upToDate': 'up to date',
  'branchStatus.worktree.none': 'No worktree',
  'branchStatus.worktree.locked': 'locked',
  'branchStatus.sync.ahead': '{n} ahead',
  'branchStatus.sync.behind': '{n} behind',
  'branchStatus.pr.number': '#{n}',
  'branchStatus.pr.open': 'open',
  'branchStatus.pr.draft': 'draft',
  'branchStatus.pr.merged': 'merged',
  'branchStatus.pr.closed': 'closed',
  'branchStatus.pr.summary': 'PR #{n} {state}',
  ...
  'action.confirmForceDeleteStandaloneTitle': 'Force-delete {branch}?',
  'action.confirmForceDeleteStandaloneBody.before': 'Local branch ',
  'action.confirmForceDeleteStandaloneBody.after':
    ' has unique commits that are not fully merged. Force-delete only if you no longer need those commits.',
  'action.confirmForceDeleteStandaloneConfirm': 'Force-delete branch',
  ...
  'action.createWorktreeBranchInvalid': 'Use a valid git branch name.',
  'action.createWorktreeBranchExists': 'A branch with this name already exists.',
  ...
  'error.branchNotFullyMerged': 'Branch has unique commits — Git refused the safe delete',
  ...
  'help.row.viewStatus': 'Branch status',
  'help.row.viewChanges': 'Changes',
  'help.row.viewLog': 'Log',
  'help.row.toggleDetail': 'Collapse / expand detail panel',
