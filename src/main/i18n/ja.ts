...
export const ja: Record<DictKey, string> = {
  ...
  'menu.view.log': 'ログ',
  'menu.view.toggleDetail': '詳細パネルを折りたたむ/展開',
  ...
  'branchDetail.collapse': '詳細パネルを折りたたむ',
  'branchDetail.collapseTitle': '詳細パネルを折りたたむ (⌘J)',
  'branchDetail.expand': '詳細パネルを展開',
  'branchDetail.expandTitle': '詳細パネルを展開 (⌘J)',
  ...
  // ---- Branch status -----------------------------------------------------
  'branchStatus.worktreeDirty': '{n} 件の変更',
  'branchStatus.merged': '含まれています',
  'branchStatus.notMerged': '固有コミットあり',
  'branchStatus.mergeUnknown': '不明',
  'branchStatus.copyBranchName': 'ブランチ名をコピー',
  'branchStatus.current': '現在',
  'branchStatus.protected': '保護',
  'branchStatus.copyWorktreePath': 'ワークツリーパスをコピー',
  'branchStatus.copied': 'コピー済み',
  'branchStatus.signal.branch': 'ブランチ',
  'branchStatus.signal.remote': 'リモート',
  'branchStatus.signal.sync': '同期',
  'branchStatus.signal.merge': 'ベースライン',
  'branchStatus.signal.worktree': 'ワークツリー',
  'branchStatus.signal.commit': '最新コミット',
  'branchStatus.sync.upToDate': '最新',
  'branchStatus.worktree.none': 'ワークツリーなし',
  'branchStatus.worktree.locked': 'ロック中',
  'branchStatus.sync.ahead': '{n} 件 ahead',
  'branchStatus.sync.behind': '{n} 件 behind',
  'branchStatus.pr.number': '#{n}',
  'branchStatus.pr.open': 'オープン',
  'branchStatus.pr.draft': 'ドラフト',
  'branchStatus.pr.merged': 'マージ済み',
  'branchStatus.pr.closed': 'クローズ',
  ...
  'action.confirmForceDeleteStandaloneTitle': '{branch} を強制削除しますか？',
  'action.confirmForceDeleteStandaloneBody.before': 'ローカルブランチ ',
  'action.confirmForceDeleteStandaloneBody.after':
    ' には完全にマージされていない固有コミットがあります。そのコミットが不要な場合のみ強制削除してください。',
  'action.confirmForceDeleteStandaloneConfirm': 'ブランチを強制削除',
  ...
  'action.createWorktreeBranchInvalid': '有効な Git ブランチ名を入力してください。',
  'action.createWorktreeBranchExists': '同じ名前のブランチがすでに存在します。',
  ...
  'error.branchNotFullyMerged': 'ブランチに固有コミットがあるため、Git が安全な削除を拒否しました',
  ...
  'help.row.viewStatus': 'ブランチステータス',
  'help.row.viewChanges': '変更',
  'help.row.viewLog': 'ログ',
  'help.row.toggleDetail': '詳細パネルを折りたたむ/展開',
